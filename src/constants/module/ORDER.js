...
export const SITE_ID = {
  ...
  GUANG_ZHOU_NAN_ZHAN_2: "0032", // 广州南站2
...
export const REFUND_TYPE_OPTIONS = () => [
  {
    label: REFUND_TYPE_TYPE[REFUND_TYPE.READY_MONEY],
    value: REFUND_TYPE.READY_MONEY,
  },
  {
    label: REFUND_TYPE_TYPE[REFUND_TYPE.READY_MONEY_SPECIAL],
    value: REFUND_TYPE.READY_MONEY_SPECIAL,
  },
  {
    label: REFUND_TYPE_TYPE[REFUND_TYPE.NON_READY_MONEY],
    value: REFUND_TYPE.NON_READY_MONEY,
  },
  {
    label: REFUND_TYPE_TYPE[REFUND_TYPE.NON_READY_MONEY_SPECIAL],
